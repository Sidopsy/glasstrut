...
public interface IGoalService
{
    ...
    Task<LogActivityResponse> UpdateActivityEntryAsync(string userId, Guid challengeId, Guid activityId, Guid entryId, LogProgressRequest request);
    ...
    Task<List<ChronicleEntryDto>> GetChronicleFeedAsync(string userId, int offset, int limit);
}
